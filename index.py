...
Top.pack(side=TOP)
Mid = Frame(root, width=500,  bg="#7AC5CD")
Mid.pack(side=TOP)
MidLeft = Frame(Mid, width=100)
MidLeft.pack(side=LEFT, pady=10)
MidLeftPadding = Frame(Mid, width=370, bg="#7AC5CD")
...
#============================BUTTONS=====================================
btn_add = Button(MidLeft, text="+ ADD NEW", bg="green", command=AddNewWindow)
btn_add.pack()
btn_delete = Button(MidRight, text="DELETE", bg="red", command=DeleteData)
btn_delete.pack(side=BOTTOM)
btn_Message = Button(MidLeftPadding, text="MESSAGE", bg="#CDC8B1", command=AddNewWindow)
